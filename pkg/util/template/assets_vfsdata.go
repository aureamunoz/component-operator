...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/outerloop": &vfsgen۰DirInfo{
			name:    "outerloop",
			modTime: time.Date(2019, 1, 30, 15, 20, 14, 222138594, time.UTC),
		},
		"/outerloop/buildconfig": &vfsgen۰CompressedFileInfo{
			name:             "buildconfig",
			modTime:          time.Date(2019, 1, 30, 10, 18, 18, 964778128, time.UTC),
		...
		"/outerloop/deploymentconfig": &vfsgen۰CompressedFileInfo{
			name:             "deploymentconfig",
			modTime:          time.Date(2019, 1, 30, 15, 20, 14, 221550157, time.UTC),
		...
		"/outerloop/imagestream": &vfsgen۰FileInfo{
			name:    "imagestream",
			modTime: time.Date(2019, 1, 30, 6, 46, 12, 600732750, time.UTC),
